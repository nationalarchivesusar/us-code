...
# cross-references or unusual drafting make any text-only recognition rule
# unnecessarily brittle. Keep that escape hatch for audited exceptions:
# §401 states the court's criminal-contempt power as authority to punish;
# §751 is a legacy drafting regression; USAR-added §242e uses the bespoke
# phrase "shall face ... imprisonment"; and §2721 states the substantive
# privacy prohibition while §2723 supplies the chapter's criminal fine.
hardener.KNOWN_TITLE18_CHARGES.update({"401", "751", "242e", "2721"})
...
# drafting styles, court-power language, cross-section criminal penalties, and
# offense headings beginning with words that can otherwise look administrative
# (Disclosure / Forfeiture / specific Penalties for ...). The USAR-added
# §242-series checks ensure the live current-law overlay is also represented,
# rather than auditing only legacy federal source text.
REQUIRED_TITLE18_CHARGES = {
    "81", "113", "241", "242a", "242b", "242e", "371", "401", "492", "605",
    "751", "752", "798", "956", "1001", "1031", "1113", "1121", "1429",
    "1501", "1505", "1751", "1902", "1905", "1906", "1907", "1962", "2075",
    "2119", "2384", "2511", "2721",
}
OBVIOUS_NON_CHARGES = {
